...
## 12. Tabela Oficial de Permissões

A tabela abaixo define, de forma objetiva, as permissões do sistema de acordo com o papel e o contexto de autenticação.

| Funcionalidade / Ação                      | Paciente (CPF)        | Médico (CRM) | Administrador |
| ------------------------------------------ | --------------------- | ------------ | ------------- |
| Cadastro e edição de perfil próprio        | ✔️                    | ✔️           | ✔️            |
| Buscar médicos e horários                  | ✔️                    | ❌            | ✔️            |
| Agendar consulta                           | ✔️                    | ❌            | ✔️            |
| Confirmar agendamento (menor de idade)     | ✔️ (maior de 18 anos) | ❌            | ✔️            |
| Confirmar comparecimento                   | ✔️                    | ❌            | ✔️             |
| Cancelar consulta                          | ✔️                    | ✔️*          | ✔️            |
| Criar e gerenciar agenda                   | ❌                     | ✔️           | ✔️             |
| Visualizar agenda                          | ❌                     | ✔️           | ✔️            |
| Visualizar informações básicas do paciente | ❌                     | ✔️           | ✔️            |
| Visualizar dados sensíveis                 | ❌                     | ❌**          | ✔️            |
| Cadastrar usuários                         | ❌                     | ❌            | ✔️            |
| Bloquear / desbloquear usuários            | ❌                     | ❌            | ✔️            |
| Visualizar auditoria                       | ❌                     | ❌            | ✔️            |

*Médicos podem cancelar apenas consultas futuras e com justificativa obrigatória.

**Médicos terão acesso a prontuários e anotações conforme regras de sigilo documentadas em versões futuras.
